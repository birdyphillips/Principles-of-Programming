...
def print_menu(cart):
    ...
    while True:
        ...
        if choice == 'a':
            ...
            if name.lower() == 'back': continue
            description = input("Enter the item description: ")
            if description.lower() == 'back': continue
            price_input = input("Enter the item price: ")
            if price_input.lower() == 'back': continue
            price = float(price_input)
            quantity_input = input("Enter the item quantity: ")
            if quantity_input.lower() == 'back': continue
            ...
            name = input("Enter the item name: ")
            if name.lower() == 'back': continue
            quantity_input = input("Enter the new quantity: ")
            if quantity_input.lower() == 'back': continue
            quantity = int(quantity_input)
...
USERS = {
    'aphillips': {
        'name': 'Andre Phillips',
        'email': 'aphillips@mail.com',
        'password': 'shop!'
    },
    'sevans': {
        'name': 'Steven Evans',
        'email': 'Steven.Evans@csuglobal.edu',
        'password': 'sh0p!'
    }
}
...
if __name__ == "__main__":
    print("*"*60)
    print("*** INSTRUCTOR NOTE: Steven Evans, please log in with your credentials below: ***")
    print("*** Username: sevans")
    print("*** Name: Steven Evans")
    print("*** Email: Steven.Evans@csuglobal.edu")
    print("*** Password: sh0p! ***")
    print("*"*60)
    main()
